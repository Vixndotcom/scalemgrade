  ...
  return (
   ...
   <div className='mb-5'>
          ...
          <div className={`${styles.paddingX} `}>
              ...
              <h1 className='text-[28px] w-[370px] text-white font-bold mt-5 border-t-[1px] pt-2 pb-2 border-t-[white] border-b-[1px]'>Contact</h1> 
   ...
   <div className='  mb-5 md:mx-5'>
          ...
          <div className={`${styles.paddingX} `}>
              <div className='mb-5 '>
                  <h1 className='text-[28px] w-[370px] text-white font-bold mt-5 border-t-[1px] pt-2 pb-2 border-t-[white] border-b-[1px]'>Useful Links</h1>  
