 ...
 return(
    <div ref={parallaxRef} className='parallax-contain'>
        <div className='para-textt' style={{ transform: `translateY(-${scrollPosition * 0.1}px)` }}>
           ...
           " With a commitment to excellence, we offer a supportive environment where challenges are met with expertise, 
           dedication, and a genuine
            passion for academic success. Your journey is unique, and so are the solutions we tailor to meet your specific needs "
           </p>
        </div>
    </div>
 )
