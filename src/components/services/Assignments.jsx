...
// Animation
  ...
  return (
    <section className={`${layout.section} mt-5 `}> 
      ...
      <div className={`w-[64px] h-[64px] rounded-full ${styles.flexCenter} border-[2px] text-white`}>  
     <h1 className='text-white'> 01. </h1>
      ...
      <p className={`${styles.paragraph} font-poppins font-normal text-white md:w-[470px] leading-[24px] mt-5`}>
